...
const validateAbastecimiento = [
  ...
  body('tipoCilindro.id').notEmpty().withMessage('El ID del tipo de cilindro no puede estar vacío'),
  body('tipoCilindro.tipo').notEmpty().withMessage('El tipo de cilindro no puede estar vacío'),
  body('estadoCilindro.id').notEmpty().withMessage('El ID del estado del cilindro no puede estar vacío'),
  body('estadoCilindro.tipo').notEmpty().withMessage('El tipo del estado del cilindro no puede estar vacío'),
