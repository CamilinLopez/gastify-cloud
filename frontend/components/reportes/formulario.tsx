        ...
        <form className="w-full flex flex-col gap-y-5" action="">
          <div className="w-full flex flex-col gap-y-2">
            ...
            <input
              ...
              className="p-4 h-14 bg-gris-1 rounded-xl w-5/12"
              type="date"
            />
          </div>
          <div className="w-full flex flex-col gap-y-2">
            <p className="text-16px">Nombre Conductor</p>
          ...
          <button
            onClick={(e) => buscar(e)}
            className="my-6 w-5/12 h-12 bg-azul rounded-xl font-Inter font-[500] text-blanco">
            Buscar
          </button>
        </form>
      </div>
